  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white p-6 sm:p-8 rounded-xl shadow-2xl w-full max-w-lg relative">
        ...
        <h2 className="text-xl sm:text-2xl font-bold text-center text-gray-800 mb-2">Start Quiz</h2>
        <p className="text-center text-gray-500 mb-6 text-sm sm:text-base">Topic: <span className="font-semibold text-gray-700">{topicTitle}</span></p>
