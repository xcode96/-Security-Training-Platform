...
const QuizResultsView: React.FC<QuizResultsViewProps> = ({ result, onReturnToDashboard, onViewProgress }) => {
    ...
    const handleDownloadPdf = async () => {
        ...
        try {
            ...
            // For a better multi-page experience, extensive logic is needed, but for this view:
    ...
    return (
        <div className="w-full max-w-4xl my-8">
            ...
            <div ref={reportRef} className="bg-white p-8 sm:p-12 rounded-2xl shadow-xl text-center text-gray-800 border border-gray-200">
                ...
                <div data-html2canvas-ignore className="mt-10">
                    <button
                        ...
                        className="w-full max-w-sm mx-auto py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-semibold rounded-lg hover:opacity-90 transition-opacity duration-300 text-lg shadow-lg mb-3 block"
                    >
                    ...
                    <button
                        ...
                        className="w-full max-w-sm mx-auto py-3 bg-white border border-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-50 transition-colors duration-300 text-lg shadow-sm mb-3 flex items-center justify-center gap-2"
                    >
                        {isGeneratingPdf ? (
